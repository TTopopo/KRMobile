...
class DBHelper(val context: Context, factory: SQLiteDatabase.CursorFactory?) :
    ...
    fun getTools(): List<Tool> {
        ...
        if (cursor.count == 0) {
            ...
            addTool(Tool(1, "молоток", "Молоток", "Обычный молоток для общего использования", 10.0, "Ручные инструменты"))
            addTool(Tool(2, "отвертка", "Отвертка", "Обычная отвертка для общего использования", 5.0, "Ручные инструменты"))
            addTool(Tool(3, "дрель", "Дрель", "Мощная дрель для сверления отверстий", 50.0, "Электроинструменты"))
            addTool(Tool(4, "пила", "Пила", "Пила для распиловки древесины", 20.0, "Ручные инструменты"))
            addTool(Tool(5, "гаечный ключ", "Гаечный ключ", "Гаечный ключ для затяжки болтов", 15.0, "Ручные инструменты"))
    ...
    fun getMaterials(): List<Material> {
        ...
        if (cursor.count == 0) {
            ...
            addMaterial(Material(1, "гвозди", "Гвозди", "Гвозди для крепления", 1.0, "Крепежные материалы"))
            addMaterial(Material(2, "винты", "Винты", "Винты для крепления", 2.0, "Крепежные материалы"))
            addMaterial(Material(3, "болты", "Болты", "Болты для крепления", 3.0, "Крепежные материалы"))
            addMaterial(Material(4, "шайбы", "Шайбы", "Шайбы для крепления", 4.0, "Крепежные материалы"))
            addMaterial(Material(5, "гайки", "Гайки", "Гайки для крепления", 5.0, "Крепежные материалы"))
